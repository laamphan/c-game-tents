...
bool test_game_is_over() {
  ...
  square squares_1[DEFAULT_SIZE * DEFAULT_SIZE] = {
      ...
      TREE, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY};
  game_delete(g);
  g = game_new(squares_1, nb_tents_row_default_test, nb_tents_col_default_test);
  assert(g);
  if (game_is_over(g)) {
    return false;
  }
  ...
  square squares_2[DEFAULT_SIZE * DEFAULT_SIZE] = {
      ...
      TREE, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY};
  game_delete(g);
  g = game_new(squares_2, nb_tents_row_default_test, nb_tents_col_default_test);
  assert(g);
  if (game_is_over(g)) {
    return false;
  }
  ...
  square squares_3[DEFAULT_SIZE * DEFAULT_SIZE] = {
      ...
      TREE, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY};
  game_delete(g);
  g = game_new(squares_3, nb_tents_row_default_test, nb_tents_col_default_test);
  assert(g);
  if (game_is_over(g)) {
    return false;
  }
  ...
  square squares_4[DEFAULT_SIZE * DEFAULT_SIZE] = {
      ...
      TREE, TENT, TENT, TENT, TENT, TENT, TENT, TENT};
  game_delete(g);
  g = game_new(squares_4, nb_tents_row_default_test, nb_tents_col_default_test);
  assert(g);
  if (game_is_over(g)) {
    return false;
  }
  ...
  square squares_6[DEFAULT_SIZE * DEFAULT_SIZE] = {
      ...
      TREE, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY};
  game_delete(g);
  g = game_new(squares_6, nb_tents_row_default_test, nb_tents_col_default_test);
  assert(g);
  if (game_is_over(g)) {
    return false;
  }
  ...
  square squares_7[DEFAULT_SIZE * DEFAULT_SIZE] = {
      ...
      TREE, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY};
  game_delete(g);
  g = game_new(squares_7, nb_tents_row_default_test, nb_tents_col_default_test);
  assert(g);
  if (game_is_over(g)) {
    return false;
  }
  ...
  square squares_9[DEFAULT_SIZE * DEFAULT_SIZE] = {
      ...
      TREE, GRASS, GRASS, GRASS, GRASS, GRASS, GRASS, GRASS};
  game_delete(g);
  g = game_new(squares_9, nb_tents_row_default_test, nb_tents_col_default_test);
  assert(g);
  if (!game_is_over(g)) {
    return false;
  }
  ...
  square squares_10[DEFAULT_SIZE * DEFAULT_SIZE] = {
      ...
      TREE, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY};
  game_delete(g);
  g = game_new(squares_10, nb_tents_row_default_test, nb_tents_col_default_test);
  assert(g);
  if (!game_is_over(g)) {
    return false;
  }
