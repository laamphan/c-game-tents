...
bool test_game_equal() {
  ...
  square squares[DEFAULT_SIZE * DEFAULT_SIZE] = {
      EMPTY, EMPTY, EMPTY, EMPTY, TREE, TREE, EMPTY, EMPTY, TREE, EMPTY,
      EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, TREE, EMPTY, EMPTY, EMPTY, EMPTY,
      TREE, EMPTY, EMPTY, EMPTY, TREE, EMPTY, EMPTY, EMPTY, EMPTY, TREE,
      EMPTY, EMPTY, EMPTY, TREE, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY,
      TREE, EMPTY, EMPTY, EMPTY, TREE, EMPTY, TREE, EMPTY, EMPTY, EMPTY,
      EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, TREE, EMPTY, EMPTY, EMPTY,
  ...
  //* Equal only squares
  nb_tents_row[0] =
      0;  // change default values of nb_tents_row[] and nb_tents_col[]
  nb_tents_col[0] = 0;
  game_delete(g2);
  g2 = game_new(squares, nb_tents_row, nb_tents_col);
  assert(g2);
  ...
  nb_tents_row[0] = 3;
  nb_tents_col[0] =
      4;  // return default values of nb_tents_row[] and nb_tents_col[]
...
bool test_game_play_move() {
  ...
  square squares_full_grass[DEFAULT_SIZE * DEFAULT_SIZE] = {
      GRASS, GRASS, GRASS, GRASS, TREE, TREE, GRASS, GRASS, TREE, GRASS,
      GRASS, GRASS, GRASS, GRASS, GRASS, TREE, GRASS, GRASS, GRASS, GRASS,
      TREE, GRASS, GRASS, GRASS, TREE, GRASS, GRASS, GRASS, GRASS, TREE,
      GRASS, GRASS, GRASS, TREE, GRASS, GRASS, GRASS, GRASS, GRASS, GRASS,
      TREE, GRASS, GRASS, GRASS, TREE, GRASS, TREE, GRASS, GRASS, GRASS,
      GRASS, GRASS, GRASS, GRASS, GRASS, GRASS, TREE, GRASS, GRASS, GRASS,
      GRASS, GRASS, GRASS, GRASS};
  square squares_full_tents[DEFAULT_SIZE * DEFAULT_SIZE] = {
      TENT, TENT, TENT, TENT, TREE, TREE, TENT, TENT, TREE, TENT, TENT,
      TENT, TENT, TENT, TENT, TREE, TENT, TENT, TENT, TENT, TREE, TENT,
      TENT, TENT, TREE, TENT, TENT, TENT, TENT, TREE, TENT, TENT, TENT,
      TREE, TENT, TENT, TENT, TENT, TENT, TENT, TREE, TENT, TENT, TENT,
      TREE, TENT, TREE, TENT, TENT, TENT, TENT, TENT, TENT, TENT, TENT,
      TENT, TREE, TENT, TENT, TENT, TENT, TENT, TENT, TENT};
  game g1 = game_default();
  assert(g1);
...
bool test_game_check_move_1() {
  square squares_1[DEFAULT_SIZE * DEFAULT_SIZE] = {
      TREE, TREE, EMPTY, TREE, EMPTY, EMPTY, EMPTY, EMPTY, TREE, TREE,
      EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, TREE, TREE, EMPTY, EMPTY,
      EMPTY, EMPTY, EMPTY, EMPTY, TREE, TREE, EMPTY, EMPTY, EMPTY, EMPTY,
      EMPTY, EMPTY, TREE, TREE, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY,
      TREE, TREE, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, TREE, EMPTY,
      EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, TREE, TREE, EMPTY, EMPTY,
      EMPTY, EMPTY, EMPTY, EMPTY};
...
bool test_game_check_move_2() {
  ...
  square squares_1[DEFAULT_SIZE * DEFAULT_SIZE] = {
      GRASS, GRASS, GRASS, GRASS, GRASS, GRASS, GRASS, EMPTY, GRASS, GRASS,
      GRASS, GRASS, GRASS, GRASS, GRASS, GRASS, GRASS, GRASS, GRASS, GRASS,
      GRASS, GRASS, GRASS, GRASS, GRASS, GRASS, TREE, TREE, TREE, TREE,
      GRASS, GRASS, GRASS, GRASS, TREE, TREE, TREE, GRASS, GRASS, GRASS,
      GRASS, GRASS, GRASS, GRASS, GRASS, GRASS, GRASS, GRASS, GRASS, GRASS,
      GRASS, GRASS, GRASS, GRASS, GRASS, GRASS, EMPTY, GRASS, GRASS, GRASS,
      GRASS, GRASS, GRASS, EMPTY};
...
bool test_game_load() {
  square squares_2x2[2 * 4] = {TREE, EMPTY, EMPTY, EMPTY,
                               EMPTY, EMPTY, TREE, EMPTY};
  ...
  square squares_3x3d[3 * 3] = {TREE, EMPTY, EMPTY, EMPTY, TREE,
                                EMPTY, EMPTY, EMPTY, EMPTY};
  ...
  square squares_3x3w[3 * 3] = {TREE, EMPTY, EMPTY, EMPTY, EMPTY,
                                EMPTY, EMPTY, EMPTY, EMPTY};
  ...
  square squares_3x3wd[3 * 3] = {EMPTY, EMPTY, TREE, EMPTY, EMPTY,
  ...
  square squares_4x4w[4 * 4] = {EMPTY, TREE, EMPTY, EMPTY, EMPTY, EMPTY,
                                EMPTY, TREE, EMPTY, EMPTY, TREE, TREE,
                                EMPTY, EMPTY, EMPTY, EMPTY};
...
bool test_game_extra() {
  ...
  // game g2 =
  //     game_new_ext(2, 4, squares_2, nb_tents_row_2, nb_tents_col_2, false,
  //     false);
